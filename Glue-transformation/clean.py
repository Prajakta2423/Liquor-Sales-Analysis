...
RAW_S3_PATH = "s3://groups-raw-data/input/"
CLEAN_S3_PATH = "s3://group5-clean-data/output/"
...
if not RAW_S3_PATH or RAW_S3_PATH.strip() == "":
    raise Exception("RAW_S3_PATH is EMPTY ❌")

if not CLEAN_S3_PATH or CLEAN_S3_PATH.strip() == "":
    raise Exception("CLEAN_S3_PATH is EMPTY ❌")
...
job = Job(glueContext)
job.init("data-clean-job", {})

# =========================================================
# 2. Read RAW CSV
# =========================================================
print("Reading from:", RAW_S3_PATH)
